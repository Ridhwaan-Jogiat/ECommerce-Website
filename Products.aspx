<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="Products.aspx.cs" Inherits="ECommerce.Products" %>
      ...
      <hr />
       ...
       <asp:repeater ID="rptrProducts" runat="server">
        ...
        <div class="col-sm-3 col-md-3">
          ...
          <div class="thumbnail">              
              <img  src="Images/ProductImages/<%# Eval("PID") %>/<%# Eval("ImageName") %><%# Eval("Extention") %>" alt="<%# Eval("ImageName") %>"  style="width: 300px; height: 300px;  margin: 0 auto;" />
              <div class="caption"> 
