        ...
        protected void btnResetPass_Click(object sender, EventArgs e)
        {
            using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["MyEComDB"].ConnectionString))
            {
                ...
                if (dt.Rows.Count != 0)
                {
                    ...
                    String EmailBody = "Hi ," + Username + ",<br/><br/>Click the link below to reset your password<br/> <br/> https://localhost:44304/RecoverPassword.aspx?id" + myGUID;


                    MailMessage PassRecMail = new MailMessage("codebuster61@gmail.com", ToEmailAddress);
                    ...
                    using (SmtpClient client = new SmtpClient())
                    {
                        ...
                        client.Credentials = new NetworkCredential("codebuster61@gmail.com", "jcqkxtfunhnmfaqr");
                    ...
                    lblResetPassMsg.Text = "Reset Link has being sent !Please Check Your email for the link to reset your password";
