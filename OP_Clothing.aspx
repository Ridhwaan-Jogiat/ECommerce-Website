<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="OP_Clothing.aspx.cs" Inherits="ECommerce.OP_Clothing" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
<title>OnePieceClothing</title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">


<div class="container">
  <h2>One Piece Clothing</h2>  

    <div class="panel panel-primary">
      <div class="panel-heading">One Piece Clothing </div>
