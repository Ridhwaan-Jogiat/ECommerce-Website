...
namespace ECommerce
{
    public partial class NarutoClothing : System.Web.UI.Page
    {
        ...
        private void BindProductRepeater()
        {
            ...
            {
                using (SqlCommand cmd = new SqlCommand("procBindNarutoClothing", con))
                {
        ...
        protected void txtFilterGrid1Record_TextChanged(object sender, EventArgs e)
        {
            if (!string.IsNullOrEmpty(txtFilterGrid1Record.Text))
            {
                ...
                {
                    con.Open();
                    string qr = "EXEC [dbo].[procBindNarutoClothing]";
