<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="LongSleeve.aspx.cs" Inherits="ECommerce.LongSleeve" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
<title>LongSleeveTShirts</title>
</asp:Content>
...
<div class="container">
  <h2>Long Sleeve T-Shirts</h2>  
    ...
    <div class="panel panel-primary">
      <div class="panel-heading">Long Sleeve T-Shirts</div>
      ...
      <asp:repeater ID="rptrProducts" runat="server">
        ...
        <div class="col-sm-3 col-md-3">
          ...
          <div class="thumbnail">              
              <img src="Images/ProductImages/<%# Eval("PID") %>/<%# Eval("ImageName") %><%# Eval("Extention") %>" alt="<%# Eval("ImageName") %>" style="width: 600px; height: 250px;  margin: 0 auto;" />
              <div class="caption"> 
