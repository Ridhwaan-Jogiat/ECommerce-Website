<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="AOT_Clothing.aspx.cs" Inherits="ECommerce.AOT_Clothing" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
<title>AttackOnTitanClothing</title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">


<div class="container">
  <h2>Attack On Titan Clothing</h2>  

    <div class="panel panel-primary">
      <div class="panel-heading">Attack On Titan Clothing </div>
