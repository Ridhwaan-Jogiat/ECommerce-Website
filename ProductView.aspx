<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="ProductView.aspx.cs" Inherits="ECommerce.ProductView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <div class="carousel-inner" role="listbox">
    ...
    <div class="item <%# GetActiveImgClass(Container.ItemIndex) %>">
      <img src="Images/ProductImages/<%# Eval("PID") %>/<%# Eval("Name") %><%# Eval("Extention") %>" alt="<%# Eval("Name") %>" onerror="this.src='Images/ImageNotAvailable.jpg'"  style="width: 300px; height: 300px;  margin: 0 auto;">
    ...
    <span class="sr-only">Next</span>
        ...
        <div class="col-md-5">
            ...
            <div class="divDet1">
                ...
                <span class="proOgPriceView"><%#Eval("PPrice","{0:c}") %></span> <span class="proPriceDiscountView"> Off R.<%# string.Format("{0}",Convert.ToInt64(Eval("PPrice"))-Convert.ToInt64(Eval("PSelPrice"))) %></span><p class="proPriceView">R <%#Eval("PSelPrice","{0:c}") %></p>
            </div>
            <div >
