<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterPage.Master" AutoEventWireup="true" CodeBehind="AddProduct.aspx.cs" Inherits="ECommerce.AddProduct" %>
           ...
           <div class ="form-group">
                    ...
                    <div class ="col-md-6 ">
                        ...
                        <asp:Button ID="btnAdd" CssClass ="btn btn-success " runat="server" Text="ADD Product" OnClick="btnAdd_Click"  />
                         <asp:Label ID="lblSuccessMessage" CssClass="success-message" runat="server" Text=""></asp:Label>
