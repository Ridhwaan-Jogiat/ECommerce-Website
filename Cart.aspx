<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="Cart.aspx.cs" Inherits="ECommerce.Cart" %>
                    ...
                    <div style="padding-top: 50px">
                                ...
                                <ItemTemplate>
                                    ...
                                    <div class="media" style="border: 1px solid black; ">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <span class="ProPriceViewCart">R.&nbsp <%#  Convert.ToDecimal(Eval("PSelPrice")).ToString("0.00") %></span>
                                            <span class="proOgPriceView">R.&nbsp <%# Eval("PPrice","{0:0.00}") %></span>

                                            <span class="proPriceDiscountView" style="color: red;"> Off R<%# string.Format("{0}",Convert.ToInt64(Eval("PPrice"))-Convert.ToInt64(Eval("PSelPrice"))) %></span>
                                    ...
                                    <asp:TextBox ID="txtQty" runat="server" Width="40" Font-Size="Large" TextMode="SingleLine" Style="text-align: center" Text='<%# Eval("Qty") %>'></asp:TextBox>&nbsp
                                     <asp:Button ID="BtnPlus" CommandArgument='<%# Eval("PID") %>' CommandName="DoPlus" runat="server" Text="+" Font-Size="Large" />&nbsp&nbsp&nbsp                                          
                                            ...
                                            <p>
                                                ...
                                                <br />
                                               <span class="proNameViewCart pull-right" style="margin-right: 10px;">SubTotal: R.&nbsp <%# Eval("SubSAmount","{0:0.00}") %></span>
                                            </p>
                                        </div>
                                    </div>
                                </ItemTemplate>
                        ...
                        <div class="col-md-3" runat="server" id="divAmountSect">
                            <div>
                                ...
                                <div>
                                    <label class="">Value-Added Tax</label>
                                    <span class="pull-right priceTax" runat="server" id="spanTax"></span>
                                </div>

                                <div>
                                    <label class="">Shipping</label>
                                    <span class="pull-right priceTax" runat="server" id="spanShip"></span>
                                </div>
