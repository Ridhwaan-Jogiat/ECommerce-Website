<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="NarutoClothing.aspx.cs" Inherits="ECommerce.NarutoClothing" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
<title>NarutoClothing</title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">


<div class="container">
  <h2>Naruto Clothing</h2>  

    <div class="panel panel-primary">
      <div class="panel-heading">Naruto Clothing </div>
