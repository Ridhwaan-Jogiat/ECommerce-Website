<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="Payment.aspx.cs" Inherits="ECommerce.Payment" %>
    ...
    <div class="row" style="padding-top: 20px;">
        ...
        <div class="col-md-9">
             <div class="form-horizontal">
                ...
                <div class="form-group">
                    <asp:Label ID="Label3" runat="server" CssClass="control-label" Text="Postal Code"></asp:Label>
